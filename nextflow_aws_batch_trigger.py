...
def main():
    ...
    parser.add_argument('--launch_template_name', dest='launch_template_name', default='test_v1')
    parser.add_argument('--key_name', dest='key_name', default='harshal_nextflow_ec2_test')
    parser.add_argument('--region_name', dest='region_name', default='us-east-1')
    parser.add_argument('--s3_bucket', dest='s3_bucket', default='harshal-redshift-training')
    parser.add_argument('--s3_logging_dir', dest='s3_logging_dir', default='s3://harshal-redshift-training/temp')
    parser.add_argument('--s3_result', dest='s3_result', default='s3://harshal-redshift-training/batch')
    parser.add_argument('--max_vCpus', dest='max_vCpus', default=256)
    parser.add_argument('--compute_environment_name', dest='compute_environment_name', default='s3fs')
    parser.add_argument('--instance_role', dest='instance_role', default='Test_hd')
    parser.add_argument('--security_groupId', dest='security_groupId', default='sg-97b165f1')
    parser.add_argument('--job_queue_name', dest='job_queue_name', default='job-queue-1')
    parser.add_argument('--s3_data', dest='s3_data', default='s3://harshal-redshift-training/nextflow/nextflow_batch/')
    parser.add_argument('--script_name', dest='script_name', default='RNASeq.nf')
    parser.add_argument('--config_file_name', dest='config_file_name', default='nextflow.config_updated_new_s3fs')
    parser.add_argument('--subnets', dest='subnets', nargs='+',
                        default=['subnet-fac7fca3', 'subnet-d49e41e9', 'subnet-0831746d', 'subnet-c3557ee8',
                                 'subnet-935abbe5', 'subnet-e89604e4'])
    parser.add_argument('--subnet1', dest='subnet1', default='subnet-fac7fca3')
    parser.add_argument('--result_location', dest='result_location', default='rnaseq')
